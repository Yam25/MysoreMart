			...
			<div class="col-md-4 mb-4 product-item atta-item">
				<div class="card atta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-wheat-atta"
								name="quantity-wheat-atta">
			...
			<div class="col-md-4 mb-4 product-item atta-item">
				<div class="card atta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-multigrain-atta"
								name="quantity-multigrain-atta">
			...
			<div class="col-md-4 mb-4 product-item atta-item">
				<div class="card atta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-besan"
								name="quantity-besan">
			...
			<div class="col-md-4 mb-4 product-item atta-item">
				<div class="card atta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-rava"
								name="quantity-rava">
			...
			<div class="col-md-4 mb-4 product-item atta-item">
				<div class="card atta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-maida"
								name="quantity-maida">
			...
			<div class="col-md-4 mb-4 product-item rice-item">
				<div class="card rice-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-basmati-rice"
								name="quantity-basmati-rice">
			...
			<div class="col-md-4 mb-4 product-item rice-item">
				<div class="card rice-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-sona-masoori-rice"
								name="quantity-sona-masoori-rice">
								<option value="500" data-price="250">500g - ₹250</option>
								<option value="1000" data-price="480">1kg - ₹480</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item rice-item">
				<div class="card rice-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-long-grain-rice"
								name="quantity-long-grain-rice">
			...
			<div class="col-md-4 mb-4 product-item rice-item">
				<div class="card rice-card">
					...
					<div class="card-body">
						...
						<p class="card-text">Rice that has been partially boiled, less
							sticky after cooking.</p>
						<p class="card-text">
							<strong>&#8377;180</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-parboiled-rice"
								name="quantity-parboiled-rice">
								<option value="500" data-price="180">500g - ₹180</option>
			...
			<div class="col-md-4 mb-4 product-item oil-item">
				<div class="card oil-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-sunflower-oil"
								name="quantity-sunflower-oil">
			...
			<div class="col-md-4 mb-4 product-item oil-item">
				<div class="card oil-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-groundnut-oil"
								name="quantity-groundnut-oil">
			...
			<div class="col-md-4 mb-4 product-item oil-item">
				<div class="card oil-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-mustard-oil"
								name="quantity-mustard-oil">
			...
			<div class="col-md-4 mb-4 product-item oil-item">
				<div class="card oil-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-coconut-oil"
								name="quantity-coconut-oil">
			...
			<div class="col-md-4 mb-4 product-item oil-item">
				<div class="card oil-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-olive-oil"
								name="quantity-olive-oil">
			...
			<div class="col-md-4 mb-4 product-item sugar-item">
				<div class="card sugar-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-white-sugar"
								name="quantity-white-sugar">
			...
			<div class="col-md-4 mb-4 product-item sugar-item">
				<div class="card sugar-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-brown-sugar"
								name="quantity-brown-sugar">
			...
			<div class="col-md-4 mb-4 product-item sugar-item">
				<div class="card sugar-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-jaggery"
								name="quantity-jaggery">
			...
			<div class="col-md-4 mb-4 product-item sugar-item">
				<div class="card sugar-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-powdered-sugar"
								name="quantity-powdered-sugar">
								<option value="500" data-price="100">500g - ₹100</option>
								<option value="1000" data-price="190">1kg - ₹190</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item sugar-item">
				<div class="card sugar-card">
					...
					<div class="card-body">
						...
						<p class="card-text">A natural sugar alternative made from the
							sap of coconut palms.</p>
						<p class="card-text">
							<strong>&#8377;200</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-coconut-sugar"
								name="quantity-coconut-sugar">
								<option value="500" data-price="200">500g - ₹200</option>
								<option value="1000" data-price="380">1kg - ₹380</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item salt-item">
				<div class="card salt-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-table-salt"
								name="quantity-table-salt">
			...
			<div class="col-md-4 mb-4 product-item salt-item">
				<div class="card salt-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-rock-salt"
								name="quantity-rock-salt">
								<option value="500" data-price="50">500g - ₹50</option>
								<option value="1000" data-price="95">1kg - ₹95</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item salt-item">
				<div class="card salt-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-pink-himalayan-salt"
								name="quantity-pink-himalayan-salt">
								<option value="500" data-price="150">500g - ₹150</option>
								<option value="1000" data-price="280">1kg - ₹280</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item salt-item">
				<div class="card salt-card">
					...
					<div class="card-body">
						...
						<p class="card-text">Natural sea salt, harvested directly from
							evaporated seawater.</p>
						<p class="card-text">
							<strong>&#8377;120</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-sea-salt"
								name="quantity-sea-salt">
								<option value="500" data-price="120">500g - ₹120</option>
								<option value="1000" data-price="230">1kg - ₹230</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item salt-item">
				<div class="card salt-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-black-salt"
								name="quantity-black-salt">
			...
			<div class="col-md-4 mb-4 product-item tea-coffee-item">
				<div class="card tea-coffee-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-tea-leaves"
								name="quantity-tea-leaves">
			...
			<div class="col-md-4 mb-4 product-item tea-coffee-item">
				<div class="card tea-coffee-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-green-tea"
								name="quantity-green-tea">
			...
			<div class="col-md-4 mb-4 product-item tea-coffee-item">
				<div class="card tea-coffee-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-instant-coffee"
								name="quantity-instant-coffee">
			...
			<div class="col-md-4 mb-4 product-item tea-coffee-item">
				<div class="card tea-coffee-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-coffee-powder"
								name="quantity-coffee-powder">
			...
			<div class="col-md-4 mb-4 product-item tea-coffee-item">
				<div class="card tea-coffee-card">
					...
					<div class="card-body">
						...
						<p class="card-text">Strong, malty tea from Assam, perfect for
							a bold and energizing.</p>
						<p class="card-text">
							<strong>&#8377;220</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-assam-tea"
								name="quantity-assam-tea">
			...
			<div class="col-md-4 mb-4 product-item baking-item">
				<div class="card baking-card">
					...
					<div class="card-body">
						...
						<p class="card-text">Versatile flour for baking cakes, cookies
							and other baked goods.</p>
						<p class="card-text">
							<strong>&#8377;40</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-all-purpose-flour"
								name="quantity-all-purpose-flour">
			...
			<div class="col-md-4 mb-4 product-item baking-item">
				<div class="card baking-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-yeast"
								name="quantity-yeast">
			...
			<div class="col-md-4 mb-4 product-item baking-item">
				<div class="card baking-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-cocoa-powder"
								name="quantity-cocoa-powder">
			...
			<div class="col-md-4 mb-4 product-item baking-item">
				<div class="card baking-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-baking-soda"
								name="quantity-baking-soda">
			...
			<div class="col-md-4 mb-4 product-item baking-item">
				<div class="card baking-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-baking-powder"
								name="quantity-baking-powder">
			...
			<div class="col-md-4 mb-4 product-item cereal-item">
				<div class="card cereal-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-rolled-oats"
								name="quantity-rolled-oats">
								<option value="500" data-price="80">500g - ₹80</option>
								<option value="1000" data-price="150">1kg - ₹150</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item cereal-item">
				<div class="card cereal-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-cornflakes"
								name="quantity-cornflakes">
			...
			<div class="col-md-4 mb-4 product-item cereal-item">
				<div class="card cereal-card">
					...
					<div class="card-body">
						...
						<p class="card-text">Light and crispy rice flakes, perfect for
							making poha, snacks.</p>
						<p class="card-text">
							<strong>&#8377;60</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-rice-flakes"
								name="quantity-rice-flakes">
			...
			<div class="col-md-4 mb-4 product-item cereal-item">
				<div class="card cereal-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-barley"
								name="quantity-barley">
								<option value="500" data-price="120">500g - ₹120</option>
								<option value="1000" data-price="230">1kg - ₹230</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item cereal-item">
				<div class="card cereal-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-sorghum"
								name="quantity-sorghum">
								<option value="500" data-price="100">500g - ₹100</option>
								<option value="1000" data-price="190">1kg - ₹190</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item pasta-item">
				<div class="card pasta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-spaghetti"
								name="quantity-spaghetti">
								<option value="500" data-price="150">500g - ₹150</option>
								<option value="1000" data-price="280">1kg - ₹280</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item pasta-item">
				<div class="card pasta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-fusilli"
								name="quantity-fusilli">
			...
			<div class="col-md-4 mb-4 product-item pasta-item">
				<div class="card pasta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-penne"
								name="quantity-penne">
			...
			<div class="col-md-4 mb-4 product-item pasta-item">
				<div class="card pasta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-mac-and-cheese"
								name="quantity-mac-and-cheese">
			...
			<div class="col-md-4 mb-4 product-item pasta-item">
				<div class="card pasta-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-lasagna"
								name="quantity-lasagna">
								<option value="500" data-price="180">500g - ₹180</option>
								<option value="1000" data-price="350">1kg - ₹350</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item noodles-item">
				<div class="card noodles-card">
					...
					<div class="card-body">
						...
						<p class="card-text">Quick and easy-to-cook noodles, available
							in different flavors.</p>
						<p class="card-text">
							<strong>&#8377;20</strong>
						</p>
						<div class="mb-3">
							<select class="form-select" id="quantity-instant-noodles"
								name="quantity-instant-noodles">
			...
			<div class="col-md-4 mb-4 product-item noodles-item">
				<div class="card noodles-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-egg-noodles"
								name="quantity-egg-noodles">
								<option value="500" data-price="100">500g - ₹100</option>
								<option value="1000" data-price="190">1kg - ₹190</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item noodles-item">
				<div class="card noodles-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-whole-wheat-noodles"
								name="quantity-whole-wheat-noodles">
								<option value="500" data-price="120">500g - ₹120</option>
								<option value="1000" data-price="230">1kg - ₹230</option>
							</select>
						</div>
			...
			<div class="col-md-4 mb-4 product-item noodles-item">
				<div class="card noodles-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-ramen"
								name="quantity-ramen">
								<option value="500" data-price="180">500g - ₹180</option>
								<option value="1000" data-price="350">1kg - ₹350</option>
							</select>
			...
			<div class="col-md-4 mb-4 product-item noodles-item">
				<div class="card noodles-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-maggi"
								name="quantity-maggi">
			...
			<div class="col-md-4 mb-4 product-item noodles-item">
				<div class="card noodles-card">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<select class="form-select" id="quantity-yippee"
								name="quantity-yippee">
								<option value="70" data-price="20">70g - ₹20</option>
								<option value="140" data-price="40">140g - ₹40</option>
							</select>
						</div>
