...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/MysoreMart/cart">
    ...
    <main class="container py-5">
        <section class="text-center" id="cart">
            ...
            %>
            <p class="item" id="cart-item-count"><%= itemCount %> items in your cart</p>
        </section>
                ...
                <div class="card">
                    <div class="card-body">
                        <div id="cart-items">
                            ...
                            %>
                            <div class="d-flex align-items-center mb-3 product border-bottom py-2" data-price="<%= item.getPrice() %>">
                                <img src="<%= item.getImgUrl() %>" class="img-fluid" alt="<%= item.getProductName() %>" style="height: 100px; width: 100px; object-fit: cover; margin-right: 15px;">
                                <div class="flex-grow-1">
                                    <h5 class="card-title"><%= item.getProductName() %>
                                        <span class="badge bg-secondary"><%= item.getSelectedQuantity() %></span>
                                    </h5>
                                    <p class="card-text">Price: &#8377;<span class="item-price"><%= item.getPrice() %></span></p>
                                    <div class="d-flex align-items-center">
                                        <button class="btn btn-outline-success me-2 decrease-qty">
                                            <i class="bi bi-dash" title="Decrease Quantity"></i>
                                        </button>
                                        <input type="number" value="1" min="1" class="form-control w-25 me-2 quantity" />
                            ...
                            %>
                            <div class="col-12">
                                <div class="alert alert-warning text-center" role="alert">Cart is empty.</div>
                            </div>
                            <%
                                }
                            %>
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="d-flex justify-content-between align-items-center">
                            <strong>Delivery Charges:</strong> <span id="delivery-charges">
                                <span id="delivery-fee" style="font-size: smaller;">&#8377;<span id="delivery-fee-value">30.00</span></span>
                                <span id="free-label" class="text-muted" style="font-size: smaller; display: none;">free</span>
                            </span>
                        </h5>
                        <h5 class="d-flex justify-content-between align-items-center">
                            <strong>Total:</strong> <strong>&#8377;<span id="cart-total">0.00</span></strong>
                        </h5>
                        <hr>
        ...
        <section id="empty-cart" class="container py-5 text-center" style="display: none;">
